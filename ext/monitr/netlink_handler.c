...
{ 
  ...
  mMonitr = rb_const_get(rb_cObject, rb_intern("Monitr"));
  cEventHandler = rb_const_get(mMonitr, rb_intern("EventHandler"));
  cNetlinkHandler = rb_define_class_under(mMonitr, "NetlinkHandler", rb_cObject);
