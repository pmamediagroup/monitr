...
#
#   Monitr::Contacts::Jabber.settings = { :jabber_id => 'sender@example.com',
#                                      :password  => 'secret' }
#   Monitr.contact(:jabber) do |c|
#     c.name      = 'Tester'
  ...
  module Contacts
    class Jabber < Contact      
      ...
      def notify(message, time, priority, category, host)
        begin
          jabber_id = XMPP4R::JID::new "#{Jabber.settings[:jabber_id]}/Monitr"
